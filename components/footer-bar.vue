<template>
  <div class="app-footer mt-24 flex h-24 flex-col justify-center bg-contain bg-center bg-no-repeat pb-12">
    <div class="mt-8 flex justify-center space-x-6">
      <a href="https://www.linkedin.com/in/romainracamier" class="app-link">
        <span class="sr-only">LinkedIn</span>
        <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          stroke-width="2" viewBox="0 0 24 24">
          <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z" />
          <circle cx="4" cy="4" r="2" />
        </svg>
      </a>
      <a href="https://github.com/Shuunen" class="app-link">
